...
- CLI-023: tail subtree (closed — token subcommand, filter parsing, URL building, output formatting, WebSocket client streaming via `tokio-tungstenite` with signal shutdown)
