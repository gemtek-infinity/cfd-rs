...
For lane and scope truth, see `REWRITE_CHARTER.md`.
For phase model and promotion gates, see `docs/promotion-gates.md`.
...
- target: frozen Go snapshot in `baseline-2026.2.0/old-impl/`
- target release: `2026.2.0`
- derived reference: `baseline-2026.2.0/design-audit/`
...
- runtime policy: `docs/allocator-runtime-baseline.md` and
