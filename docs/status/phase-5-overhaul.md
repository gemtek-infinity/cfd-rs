...
For detailed execution planning, [FINAL_PHASE.md](../../FINAL_PHASE.md) wins.
...
- three complete 150-row parity ledgers:
...
- a repository execution plan for the overhaul in [FINAL_PHASE.md](../../FINAL_PHASE.md)
- root [README.md](../../README.md) and per-crate [README.md files](../../crates/)
...
- scope triage document and 12 feature-group audit documents under [docs/parity/](../parity/)
...
- [FINAL_PHASE.md](../../FINAL_PHASE.md) — detailed execution reference (audit domains, evidence
  rules, refactor rules, risk register, contributor workflow)
- [docs/parity/cli/implementation-checklist.md](../parity/cli/implementation-checklist.md)
- [docs/parity/cdc/implementation-checklist.md](../parity/cdc/implementation-checklist.md)
- [docs/parity/his/implementation-checklist.md](../parity/his/implementation-checklist.md)

Additional feature-group parity documents may be added under [docs/parity/](../parity/)
...
- CLI baseline evidence captures exist in [docs/parity/cli/captures/](../parity/cli/captures/):
...
- document reconciliation list complete enough to execute: **yes** — see
  [FINAL_PLAN.md](../../FINAL_PLAN.md) § Complete Document Reconciliation Inventory
...
- [.github/copilot-instructions.md](../../.github/copilot-instructions.md) updated — added [FINAL_PLAN.md](../../FINAL_PLAN.md) and
  [FINAL_PHASE.md](../../FINAL_PHASE.md) to governing files list; added parity work routing section
  with domain identification, ledger links, and cross-domain gap ranking
  pointer
- [AGENTS.md](../../AGENTS.md) updated — added parity ledgers, [FINAL_PLAN.md](../../FINAL_PLAN.md),
  [FINAL_PHASE.md](../../FINAL_PHASE.md), and [docs/deployment-notes.md](../deployment-notes.md) to "Use the right file"
  ...
  rules; added [CONTRIBUTING.md](../../CONTRIBUTING.md), [docs/code-style.md](../code-style.md), and
  [docs/engineering-standards.md](../engineering-standards.md) to routing table
- [SKILLS.md](../../SKILLS.md) updated — replaced stale "first-slice bias" section with
...
- [.github/instructions/rust.instructions.md](../../.github/instructions/rust.instructions.md) updated — replaced "for
  first-slice work" scoping with general synchronous-first preference
  (Tokio runtime is now active)
- [.github/instructions/markdown.instructions.md](../../.github/instructions/markdown.instructions.md) reviewed — no changes
  needed (already accurate and consistent)
- [docs/ai-context-routing.md](../ai-context-routing.md) updated — added "Parity audit, implementation,
...
- [CONTRIBUTING.md](../../CONTRIBUTING.md) created — human contributor guide with build instructions,
...
- [docs/code-style.md](../code-style.md) updated — added quick-reference summary table linking
...
- [docs/engineering-standards.md](../engineering-standards.md) updated — added quick-reference summary
...
- [README.md](../../README.md) updated — Contributing section now links to [CONTRIBUTING.md](../../CONTRIBUTING.md)
  with quick-start pointers to code-style, engineering-standards, parity
  index, and AI routing docs
- [docs/README.md](../README.md) updated — Rust Coding References section now includes
  [CONTRIBUTING.md](../../CONTRIBUTING.md) and updated descriptions with rule counts
- [AGENTS.md](../../AGENTS.md) updated — added [CONTRIBUTING.md](../../CONTRIBUTING.md), [docs/code-style.md](../code-style.md), and
  [docs/engineering-standards.md](../engineering-standards.md) to "Use the right file" routing

Stage 2.4 outputs:

- [docs/deployment-notes.md](../deployment-notes.md) updated — added parity ledger cross-references,
  linked known deployment gaps to HIS checklist rows (HIS-012 through HIS-017,
  HIS-022), linked operational caveats to
  CDC checklist rows (CDC-001, CDC-002, CDC-011, CDC-012, CDC-018, HIS-041,
  HIS-042)
- [docs/parity/README.md](../parity/README.md) created — parity navigation index with domain
  summaries, document links, cross-domain gap count table, and source-of-truth
  note
- [docs/README.md](../README.md) updated — added parity index link and new Operator Guidance
...
- [crates/cfdrs-shared/tests/README.md](../../crates/cfdrs-shared/tests/README.md) reviewed — already updated in
  Stage 2.3, no further changes needed

Stage 2.3 outputs:

- [docs/first-slice-freeze.md](../first-slice-freeze.md) marked as historical record — first slice
  complete and parity-backed, broader parity governed by domain ledgers
- [docs/status/first-slice-parity.md](first-slice-parity.md) marked as historical record — first
  slice only, broader parity tracked by domain ledgers
- [docs/status/porting-rules.md](porting-rules.md) marked as partially superseded — first
  implementation gate satisfied, first slice complete, broader porting governed
  by final-phase program
- [crates/cfdrs-shared/tests/README.md](../../crates/cfdrs-shared/tests/README.md) updated — broader parity
  tracking pointer added
- [tools/first_slice_parity.py](../../tools/first_slice_parity.py) reviewed — already clearly scoped to
  first-slice surface, no changes needed

Stage 2.1 outputs:

- root [README.md](../../README.md) created — honest about current state, gaps, and parity
  progress
- [STATUS.md](../../STATUS.md) reduced to a short index with ledger-grounded truth
- [docs/README.md](../README.md) updated with clear section groupings and parity links
- [docs/status/rewrite-foundation.md](rewrite-foundation.md) reduced — removed duplication of lane
  and phase model owned by other governing docs
- [docs/status/active-surface.md](active-surface.md) rewritten — replaced 200+ lines of
  phase-by-phase accretion with crate-grounded content that points to parity
  ledgers
- [docs/promotion-gates.md](../promotion-gates.md) reviewed — no changes needed (governing truth is
  accurate)

Stage 2.2 outputs:

- [REWRITE_CHARTER.md](../../REWRITE_CHARTER.md) reviewed — no changes needed (governing truth is
  accurate)
- [docs/compatibility-scope.md](../compatibility-scope.md) reviewed — no changes needed
- [docs/build-artifact-policy.md](../build-artifact-policy.md) reviewed — no changes needed
- [docs/dependency-policy.md](../dependency-policy.md) updated — deferred dependency buckets reconciled
...
- [docs/allocator-runtime-baseline.md](../allocator-runtime-baseline.md) updated — removed embedded phase
  number from scaffold honesty rule; language is now phase-agnostic
- [docs/go-rust-semantic-mapping.md](../go-rust-semantic-mapping.md) updated — "Current Scaffold Application"
...
- [docs/adr/0001-hybrid-concurrency-model.md](../adr/0001-hybrid-concurrency-model.md) updated — "Current Scaffold
...
- [docs/adr/0002-transport-tls-crypto-lane.md](../adr/0002-transport-tls-crypto-lane.md) reviewed — no changes needed
- [docs/adr/0003-pingora-critical-path.md](../adr/0003-pingora-critical-path.md) updated — acknowledged that
  `pingora-http` is admitted in workspace dependencies; removed stale
  deferred follow-ups for ADRs that already exist
- [docs/adr/0004-fips-in-alpha-definition.md](../adr/0004-fips-in-alpha-definition.md) reviewed — no changes needed
- [docs/adr/0005-deployment-contract.md](../adr/0005-deployment-contract.md) reviewed — no changes needed
...
- Stage 3.3 (tooling and automation hardening): **complete**
...
- [docs/status/stage-3.1-scope-triage.md](stage-3.1-scope-triage.md) created — scope boundary document
...
- do not create target crates or begin ownership moves before the Stage 1 audit gate
  and the minimum Stage 2 documentation gate described in [FINAL_PHASE.md](../../FINAL_PHASE.md) are satisfied
...
- [docs/parity/cli/implementation-checklist.md](../parity/cli/implementation-checklist.md) § Gap ranking by priority
- [docs/parity/cdc/implementation-checklist.md](../parity/cdc/implementation-checklist.md) § Gap ranking by priority
- [docs/parity/his/implementation-checklist.md](../parity/his/implementation-checklist.md) § Gap ranking by priority

## Target Crate Map Justification

The target crate map in [FINAL_PLAN.md](../../FINAL_PLAN.md) is justified by the audited parity
...
| `cfdrs-cli` | Owns the 32-row CLI parity surface: command tree, help text, flags, env bindings, exit codes, formatting. All 9 critical CLI gaps and 13 high CLI gaps land here. Current Rust CLI surface lives in [crates/cfdrs-cli/src/](../../crates/cfdrs-cli/src/). |
...
- [docs/promotion-gates.md](../promotion-gates.md) owns phase and promotion truth
- [FINAL_PHASE.md](../../FINAL_PHASE.md) owns overhaul execution detail
...
under [cfdrs-shared/src/config/](../../crates/cfdrs-shared/src/config/) subdirectory. All documentation
reconciled to reference new crate names.

The next bounded action is:

- Stage 3 is complete. All sub-stages finished.

Stage 3.3 completion:

1. [.debtmap.toml](../../.debtmap.toml) — verified: pattern-based config covers new crate paths,
   no crate-specific paths required
2. [tools/first_slice_parity.py](../../tools/first_slice_parity.py) and [tools/first_slice_go_capture/](../../tools/first_slice_go_capture/) — marked
   as historical tooling with header comments; paths already updated to
   `cfdrs-shared`
3. MCP server ([tools/mcp-cfd-rs/](../../tools/mcp-cfd-rs/)) — verified: routes and context bundles
   use doc-file references, no hard-coded crate names; workspace discovery
   is path-based
4. parity capture harnesses — verified: buildable and runnable; fixture paths
   reference [cfdrs-shared/tests/fixtures/first-slice/](../../crates/cfdrs-shared/tests/fixtures/first-slice/)
5. [rustfmt.toml](../../rustfmt.toml) — verified: applies correctly across all crates
6. build, test, clippy, and fmt — verified: all pass across the full workspace
7. stale temp-dir prefixes in 3 test files fixed (`cloudflared-config-` →
   `cfdrs-shared-`)
