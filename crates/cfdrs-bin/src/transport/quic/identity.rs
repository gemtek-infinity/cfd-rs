...
use cfdrs_shared::{OriginCertLocator, OriginCertToken, TunnelCredentialsFile, TunnelSecret};
use uuid::Uuid;
...
fn origin_cert_path(credentials: &cfdrs_shared::CredentialSurface) -> Option<PathBuf> {
