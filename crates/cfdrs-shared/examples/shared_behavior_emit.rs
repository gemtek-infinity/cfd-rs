...
use cfdrs_shared::{
    ConfigSource, DiscoveryDefaults, DiscoveryRequest, NormalizedIngress, OriginCertToken,
...
fn emit_fixture_for_category(
    plan: &EmissionPlan,
    fixture: &FixtureSpec,
) -> Result<cfdrs_shared::artifact::ArtifactEnvelope, Box<dyn std::error::Error>> {
...
fn write_fixture_output(
    output_dir: &Path,
    fixture: &FixtureSpec,
    envelope: &cfdrs_shared::artifact::ArtifactEnvelope,
