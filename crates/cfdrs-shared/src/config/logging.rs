//! Cross-domain log configuration types.
//!
//! These types are shared by CLI (flag parsing), CDC (filter matching), and
//! HIS (sink configuration). Sink implementations, file rotation, journald
//! wiring, and host log collection remain in `cfdrs-his`.
//!
//! See ADR-0007 for the boundary rationale.
