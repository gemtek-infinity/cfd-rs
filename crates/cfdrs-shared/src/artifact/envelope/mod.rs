...
use super::types::{ArtifactEnvelope, FixtureSpec, NormalizedConfigPayload, ReportKind, SCHEMA_VERSION};
use crate::config::normalized::NormalizedConfig;
...
pub fn discovery_envelope(
    ...
    envelope_with_payload(fixture, ReportKind::Discovery, serde_json::to_value(payload)?)
}
