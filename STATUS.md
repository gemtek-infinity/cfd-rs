...
- complete Stage 1 parity audit across three domains (150 rows total):
  - CLI: 32 rows — `docs/parity/cli/implementation-checklist.md`
  - CDC: 44 rows — `docs/parity/cdc/implementation-checklist.md`
  - HIS: 74 rows — `docs/parity/his/implementation-checklist.md`
...
- `docs/status/rewrite-foundation.md` — baseline, lane, workspace shape
- `docs/status/active-surface.md` — current crate content and admitted scope
- `docs/status/first-slice-parity.md` — first-slice closure (historical)
- `docs/status/porting-rules.md` — first-slice porting rules (historical)
- `docs/status/phase-5-overhaul.md` — Big Phase 5 execution tracker

## Routing

- parity progress → three implementation checklists under `docs/parity/`
- overhaul stage tracking → `docs/status/phase-5-overhaul.md`
- phase model and promotion → `docs/promotion-gates.md`
