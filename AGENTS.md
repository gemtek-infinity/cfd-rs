...
- [`GCFGR.md`](GCFGR.md) — local session handoff state (read this FIRST if it exists; it is your context recovery file)
...
- read [`GCFGR.md`](GCFGR.md) at cold start and after any context compaction; update it before ending a non-trivial session
